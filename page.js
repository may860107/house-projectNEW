import { client } from '../sanity'; // 引入上一層的 sanity 設定
              ...
              <div key={house._id} className="bg-white rounded-xl shadow-sm overflow-hidden hover:shadow-lg transition group">
                ...
                <div className="p-5">
                  ...
                  <div className="flex justify-between items-center pt-3 border-t border-gray-100 mt-2">
                    <span className="text-xl font-bold text-red-500">${house.price.toLocaleString()} <span className="text-sm text-gray-400">/月</span></span>
